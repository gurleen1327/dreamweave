...
export async function POST(request: Request) {
  try {
    ...
    const apiKey = process.env.GEMINI_API_KEY || process.env.GEMINI_API_KEY;    const url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite:generateContent?key=" + apiKey;
